---
title: Watch & Why
description: The read-only observation commands • stream binds and releases, and get a real answer when a port refuses to bind.
section: Guides
order: 4
mode: cli
related:
...
Two commands that never signal anything. `watch` tells you what your ports are _doing_; `why` tells
