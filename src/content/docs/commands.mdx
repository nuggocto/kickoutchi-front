...
description: Options, filters, output modes, and exit codes for both binary names and all five subcommands.
section: Reference
order: 1
mode: cli
related:
...
Use this page when you know the command and need its exact syntax. For worked examples, see the
